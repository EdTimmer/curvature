...
const Torus = () => {
  ...
  useFrame((state, delta) => {
    ...
    // This makes the torus orbit around the center of the scene
    groupRef.current.rotation.z += delta * 0.055; // Adjust speed as needed
  });
    ...
    <group ref={groupRef} position={[0, 0, 0]}>
      <group ref={torusGroupRef} position={[28, 0, 0]}>
        ...
        >
          ...
          <Sphere position={[0, 0.2, 28]} size={0.05} color={'white'} />
          ...
          <Sphere position={[20, 0, 20]} size={0.05} color={'red'} />
          <Sphere position={[20, 0, -20]} size={0.05} color={'red'} />
          {/* <ShaderCube position={[20, 0, -20]} size={0.1} /> */}
        </Float>
